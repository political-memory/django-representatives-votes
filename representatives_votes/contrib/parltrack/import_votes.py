...
class Command(object):
    ...
    def parse_proposal_data(self, proposal_data, dossier_pk):
        ...
        # the votes.models.skip_votes to skip votes which have no
        # votes.models.Recommendation.
        responses = vote_pre_import.send(sender=self, vote_data=proposal_data)

        # Any connected receiver which returns False will prevent parsing of
        # votes for optimization purposes.
